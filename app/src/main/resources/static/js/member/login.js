 ...
 function onSignIn(googleUser) {
     ...
     $.ajax({
         ...
         , data: {personFields:'birthdays', key:'AIzaSyDKMxZVVZvsxgyr1Ss2A3EvdC8_XJG6f2g', 'access_token': access_token}
         , method:'GET'
     })
         .done(function(e){
             //프로필을 가져온다.
             var profile = googleUser.getBasicProfile();
             //window.location.href='http://localhost:22222/main/main';
             window.location.assign("http://localhost:22222/main/main");
             console.log(profile)
         })
         .fail(function(e){
             console.log(e);
         })
     //ajax가 아닌 페이지 이동을 해야함
    /!* let prepareUrl="https://people.googleapis.com/v1/people/me";
     let dataFieldsUrl=`?personFields='birthdays'?key='AIzaSyDKMxZVVZvsxgyr1Ss2A3EvdC8_XJG6f2g'?access_token='`+access_token+`'`;
     location.href=prepareUrl+dataFieldsUrl;*!/
